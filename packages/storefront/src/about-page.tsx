...
export function AboutPage({ brand }: { brand: BrandConfig }) {
  ...
  return <main id="conteudo" className={`about-page ${brand.channel}-about`}>
    ...
    <section className="about-story shell"><p className="eyebrow">Quem somos</p><div><h2>Experiência de fábrica em cada pedido.</h2><p>O grupo Lenterne se consolidou no fornecimento e na fabricação de acessórios para cordões de crachá, ferragens e produtos plásticos. Em Taboão da Serra, combinamos experiência, tecnologia e acompanhamento direto para atender empresas, eventos, revendas e operações de produção.</p></div></section>
