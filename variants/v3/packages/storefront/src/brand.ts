...
export const giftsBrand: BrandConfig = {
  ...
  switchUrl: process.env.NEXT_PUBLIC_FERRAGENS_URL ?? "https://lenterne-v3-ferragens.vercel.app"
};
...
export const hardwareBrand: BrandConfig = {
  ...
  switchUrl: process.env.NEXT_PUBLIC_BRINDES_URL ?? "https://lenterne-v3-brindes.vercel.app"
};
